 ...
 * @see  StatViewServlet
 */
public class LazyStatViewServlet extends LazyResourceServlet {
    private static final Log LOG = LogFactory.getLog(LazyStatViewServlet.class);
