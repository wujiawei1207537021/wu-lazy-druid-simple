package com.wu.framework.inner.lazy.example.domain.application.command.sys.user;
...
@Schema(title = "sys_user_query_List_command",description = "用户")
public class SysUserQueryListCommand {
